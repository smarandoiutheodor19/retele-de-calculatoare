...
//			if(name == Integer.parseInt(ResourceBundle.getBundle("settings").getString("cod1")) || code == Integer.parseInt(ResourceBundle.getBundle("settings").getString("cod2")) || 
//					code == Integer.parseInt(ResourceBundle.getBundle("settings").getString("cod3"))) {
